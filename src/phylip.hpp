...
#define epsilon_small         0.0001  /* small number used in makenewv */
...
typedef struct node {
  ...
  vector <double>d;              /* for distance matrix programs           */
  vector <double>w;              /* for distance matrix programs           */
...
void   EOF_error(void);
void   getstryng(char *);
void   openfile(FILE **,const char *,const char *,const char *,char *,
                char *);
void   cleerhome(void);
...
void   commentskipper2(vector<string>, long *);
long   countcomma(FILE **, long *);
long   countcomma2(vector<string> , long *);
long   countsemic(FILE **);
long   countsemic2(vector<string>);
...
void   getoptions2(void);
void   count_siblings(node **p);
void   treeout(node *);
string main_consensus(char *argv[]);

/*int main_consense(int argc, char *argv[]);
void getoptions2();
void getoptions();
void count_siblings(node **p);
void treeout(node *p);*/
