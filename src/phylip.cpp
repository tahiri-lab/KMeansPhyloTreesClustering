...
char* get_command_name (char *vektor)
...
void openfile(FILE **fp,const char *filename,const char *filedesc,
              const char *mode,char *application, char *perm)
    ...
    char **row_head, char **col_head, int flags)
{
  ...
  unsigned long headwidth;              /* min width of row header column */
